...
require_once __DIR__ . DIRECTORY_SEPARATOR . 'to-title-case.php';
...
$output = '';
$pattern = '<tr><td>%s</td><td>%s</td><td%s>%s</td><td%s>%s</td></tr>';
foreach ( $test_cases as $test_case ) {
	$input    = $test_case['input'];
	$expect  = $test_case['expect'];
	$result   = to_title_case( $test_case['input'] );
	$is_valid = $expect === $result;
